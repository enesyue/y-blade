...
# Getting started
We've made y-blade super quick to get up and running, allowing you to start developing your theme in seconds.
...
```bash
composer create-project enesyue/y-blade
```
...
# Building assets
y-blade builds your style.css and js files using Laravel Mix. This allows you to use the latest
...
# Using Blade
y-blade ships with Blade support baked in. Blade is a powerful templating engine provided in the 
Laravel framework, and developers love it for the power it offers whilst remaining easy and enjoyable
to use.

All blade files are stored in the theme's 'templates' directory. y-blade can automatically detect
...
To help with this, y-blade includes a custom blade directive: ```@loop```. This allows you to 
...
# Using Tailwind
Tailwind is baked right into y-blade, and you can start using it right away. In fact, 
...
# Using Alpine
Alpine is baked right into y-blade, and you can start using it right away. In fact,
you can check out our example index file in 'templates/index.blade.php' to see it in use.
